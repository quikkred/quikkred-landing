    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            connect-src 'self' ${apiDomain} ${appDomain} https://alpha.quikkred.in https://ifsc.razorpay.com https://api.razorpay.com https://lumberjack.razorpay.com https://www.google-analytics.com https://stats.g.doubleclick.net https://cdn.jsdelivr.net https://storage.googleapis.com;
