    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg p-4 border border-[#E0E0E0] shadow-sm">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4 flex-1">
            ...
            <div className="relative flex-1 sm:max-w-xs">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 bg-[#FAFAFA] text-[#1B5E20] border border-[#E0E0E0] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#2E7D32] text-base sm:text-sm"
                style={{ fontSize: '16px' }}
              />
            </div>
            ...
            <select
              ...
              className="w-full sm:w-auto px-4 py-2.5 bg-[#FAFAFA] text-[#1B5E20] border border-[#E0E0E0] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#2E7D32] text-base sm:text-sm"
              style={{ fontSize: '16px' }}
            >
          ...
          {/* View Mode Toggle */}
          <div className="flex items-center justify-end space-x-1 bg-[#FAFAFA] rounded-lg p-1 border border-[#E0E0E0] w-fit self-end lg:self-auto">
            <button
              onClick={() => setViewMode('grid')}
              className={`p-2.5 min-w-[44px] min-h-[44px] flex items-center justify-center rounded ${viewMode === 'grid' ? 'bg-[#2E7D32]/10 text-[#2E7D32]' : 'text-gray-600'}`}
            >
              <Grid className="w-5 h-5" />
            </button>
            <button
              onClick={() => setViewMode('list')}
              className={`p-2.5 min-w-[44px] min-h-[44px] flex items-center justify-center rounded ${viewMode === 'list' ? 'bg-[#2E7D32]/10 text-[#2E7D32]' : 'text-gray-600'}`}
            >
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <div className="flex items-center space-x-1 sm:space-x-2">
            <button
              ...
              className="min-w-[44px] min-h-[44px] px-3 py-2 bg-white border border-[#E0E0E0] hover:bg-[#FAFAFA] disabled:bg-gray-100 disabled:text-gray-400 text-[#1B5E20] rounded transition-colors flex items-center justify-center"
            >
            ...
            {Array.from({ length: Math.min(5, totalPages) }, (_, i) => {
              ...
              return (
                <button
                  ...
                  className={`min-w-[44px] min-h-[44px] px-3 py-2 rounded transition-colors text-sm sm:text-base flex items-center justify-center ${
                    currentPage === pageNum
