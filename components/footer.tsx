            ...
            <ul className="space-y-2 sm:space-y-3 flex flex-col items-center sm:items-start">
              <li>
                ...
                >
                  ...
                  <span>Call: {t.footer.contact.phone}</span>
                </a>
              </li>
              <li>
                <a
                  href={`https://wa.me/91${t.footer.contact.whatsapp?.replace(/[^0-9]/g, '').slice(-10)}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-slate-400 hover:text-[#25CE60] flex items-center gap-2 text-xs sm:text-sm"
                >
                  ...
                  <span>WhatsApp: {t.footer.contact.whatsapp}</span>
                </a>
              </li>
              <li>
                <a
