        ...
        <div className="grid grid-cols-1 gap-8 items-center md:grid-cols-2 md:gap-12 lg:gap-16">
          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-base md:text-lg text-gray-600 leading-relaxed max-w-md">{description}</p>
            </div>
              ...
              {features.map((feature, index) => (
                <div key={index} className="flex gap-4">
                  <div className="flex-shrink-0 flex items-start pt-1">
                    <div className="flex items-center justify-center w-6 h-6 text-teal-500">{feature.icon}</div>
                  </div>
