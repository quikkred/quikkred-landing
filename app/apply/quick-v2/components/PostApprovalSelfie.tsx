                      ...
                      {isStreaming && (
                        <div className="absolute inset-0 pointer-events-none">
                          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-40 h-52 sm:w-48 sm:h-64 border-2 sm:border-4 border-white/50 rounded-[50%]">
                            <div className={`absolute -top-6 sm:top-2 left-1/2 -translate-x-1/2 px-2 sm:px-3 py-1 sm:py-1.5 rounded-full ${
                              faceDetected ? 'bg-[#25B181]' : 'bg-yellow-500'
                  ...
                  {!capturedImage ? (
                    <>
                      ...
                      <button
                        ...
                        className={`flex-1 px-3 sm:px-4 py-2.5 sm:py-3 rounded-lg sm:rounded-xl font-semibold text-sm flex items-center justify-center gap-1.5 sm:gap-2 active:scale-[0.98] touch-manipulation ${
                          faceDetected
