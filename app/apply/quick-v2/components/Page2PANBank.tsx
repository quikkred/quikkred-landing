            ...
            <div className="grid grid-cols-2 gap-2">
              {EMPLOYMENT_TYPES.map((type) => (
                <button
                  ...
                  className={`py-2.5 sm:py-3 px-3 sm:px-4 rounded-lg font-medium text-xs sm:text-sm transition-all active:scale-[0.98] touch-manipulation ${
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full pl-9 sm:pl-10 pr-3 sm:pr-4 py-2.5 sm:py-3 border rounded-lg text-sm sm:text-base focus:ring-2 focus:ring-[#25B181] ${
              ...
              <div className="relative">
                ...
                <select
                  ...
                  className={`w-full pl-9 sm:pl-10 pr-3 sm:pr-4 py-2.5 sm:py-3 border rounded-lg text-sm sm:text-base focus:ring-2 focus:ring-[#25B181] appearance-none ${
                    errors.salaryDate ? 'border-red-500' : 'border-gray-300'
                  }`}
                >
            ...
            <div className="flex flex-col sm:flex-row gap-2">
              <div className="relative flex-1">
                <input
                  ...
                  maxLength={10}
                  className={`w-full px-3 sm:px-4 py-2.5 sm:py-3 border rounded-lg text-sm sm:text-base focus:ring-2 focus:ring-[#25B181] uppercase disabled:bg-gray-100 ${
      ...
      <div className="flex gap-2 sm:gap-3">
        ...
        <div className="relative group">
          <button
            ...
            className={`px-3 sm:px-4 py-3 sm:py-3.5 border rounded-lg font-medium text-sm flex items-center gap-1.5 active:scale-[0.98] touch-manipulation ${
              formData.panVerified
