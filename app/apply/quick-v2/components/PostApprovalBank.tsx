...
export default function PostApprovalBank({
  ...
  const handleIFSCChange = (value: string) => {
    ...
    setFormData(prev => ({ ...prev, ifsc: cleaned, bankName: '' }));
    setIfscError('');
        ...
        <div className="space-y-3">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  maxLength={11}
                  className={`w-full px-3 sm:px-4 py-2.5 sm:py-3 border rounded-lg text-sm focus:ring-2 focus:ring-[#25B181] uppercase ${
                    errors.ifsc || ifscError ? 'border-red-500' : 'border-gray-300'
                  }`}
                />
                {ifscLoading && (
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-3 sm:px-4 py-2.5 sm:py-3 border rounded-lg text-sm focus:ring-2 focus:ring-[#25B181] ${
