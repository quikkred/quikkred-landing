            ...
            <div className="flex flex-col sm:flex-row gap-2">
              <div className="relative flex-1">
                <input
                  ...
                  maxLength={14}
                  className={`w-full px-3 sm:px-4 py-2.5 sm:py-3 border rounded-lg focus:ring-2 focus:ring-[#25B181] disabled:bg-gray-100 tracking-widest text-sm sm:text-base font-mono ${
                    aadhaarError ? 'border-red-500' : verified ? 'border-green-500 bg-green-50' : 'border-gray-300'
                  }`}
              ...
              <div className="flex justify-center gap-1.5 sm:gap-2 mb-3 sm:mb-4">
                {otp.map((digit, index) => (
                  <input
                    ...
                    maxLength={1}
                    className={`w-10 h-12 sm:w-12 sm:h-14 text-center text-lg sm:text-xl font-bold border rounded-lg focus:ring-2 focus:ring-[#25B181] ${
