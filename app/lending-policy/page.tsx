          ...
          >
            ...
            <div className="mb-10">
              ...
              <div className="mt-4 bg-green-50 border-l-4 border-green-400 p-4">
                <p className="text-[#2b2b2b] leading-[1.7]">
                  <strong>Transparency Commitment:</strong> All applicable charges including processing fees, interest rates (APR), penal charges, and other fees are disclosed upfront in the Key Fact Statement (KFS) before loan sanction.
                </p>
              </div>
            </div>
