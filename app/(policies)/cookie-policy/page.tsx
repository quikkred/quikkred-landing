        ...
        <div>
          ...
          <div className="bg-gradient-to-br from-[#2BB89A]/10 to-[#2BB89A]/5 border-l-4 border-[#2BB89A] rounded-lg p-6">
            <ul className="space-y-2">
              ...
              <li className="text-gray-600">
                <strong className="text-gray-700">{t?.policies?.common?.address || "Address"}:</strong> {sections?.contact?.address || "1008, 13th floor, Vikrant Tower, Rajendra Place, New Delhi - 110008"}
              </li>
            </ul>
          </div>
