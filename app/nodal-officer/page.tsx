        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          >
            ...
            <div className="flex items-center gap-2 text-white/80 mb-6">
              ...
              <span className="text-white">Nodal Officer</span>
            </div>
        ...
        >
          <div className="bg-white rounded-2xl p-8 shadow-xl border border-slate-100">
            <div className="flex items-start gap-6 mb-8">
              <div className="w-24 h-24 bg-gradient-to-br from-[#25B181] to-[#1F8F68] rounded-2xl flex items-center justify-center flex-shrink-0">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="flex items-start gap-4 p-4 bg-[#E8F7F3] rounded-xl">
                <Mail className="w-6 h-6 text-[#25B181] flex-shrink-0" />
                <div>
                  <h3 className="font-bold mb-1">Email Address</h3>
                  <a href="mailto:nodal@quikkred.in" className="text-[#25B181] hover:underline">
                    nodal@quikkred.in
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 p-4 bg-[#E8F7F3] rounded-xl">
                ...
                <div>
                  ...
                  <a href="tel:+919311964796" className="text-[#25B181] hover:underline">
                    +91-9311964796
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 p-4 bg-[#E8F7F3] rounded-xl">
                <MapPin className="w-6 h-6 text-[#25B181] flex-shrink-0" />
                <div>
              ...
              <div className="flex items-start gap-4 p-4 bg-[#E8F7F3] rounded-xl">
                <Clock className="w-6 h-6 text-[#25B181] flex-shrink-0" />
                <div>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                <p className="flex items-center gap-2">
                  ...
                  <span>principal.nodal@quikkred.in</span>
                </p>
                <p className="flex items-center gap-2">
                  <Phone className="w-4 h-4" />
                  <span>+91-9311964796</span>
                </p>
              </div>
            </div>
          </div>
